...
public class ChatClient2 {
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(() -> new ChatClient2().createAndShowGUI());  // Creeaza si afiseaza interfata grafica pe thread-ul de GUI
    }

    public void createAndShowGUI() {
        frame = new JFrame("Chat Client 2");  // Creeaza fereastra principala
    ...
    private void sendMessage() {
        ...
        if (message != null && !message.trim().isEmpty()) {
            out.println("Client 2: " + message);  // Trimite mesajul la server
